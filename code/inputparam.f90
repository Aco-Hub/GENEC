module inputparam
  ...
  logical,parameter:: xyfiles_default=.false.,bintide_default=.false.,const_per_default=.true.,&
    extracoupling_default=.false.,var_rates_default=.false.,verbose_default=.false.,Add_Flux_default = .true.,&
...
! **** Rotation-linked parameters
  namelist /RotationParams/idiff,iadvec,istati,icoeff,fenerg,richac,igamma,frein,K_Kawaler,Omega_saturation,rapcrilim, &
                           vwant,xfom,omega,xdial,idialo,idialu,extracoupling,Add_Flux,diff_only
    ...
    logical,save:: extracoupling=extracoupling_default,Add_Flux=Add_Flux_default,diff_only=diff_only_default
