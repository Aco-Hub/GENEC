module inputparam
  ...
  integer,parameter:: imagn_default=0,ianiso_default=0,ipop3_default=0,ibasnet_default=0,iopac_default=3,&
    ...
    iout_default=0,itmin_default=5,idebug_default=0,itests_default=0,EOS_default=0
...
! **** Physical inputs
  integer,save:: irot,isol,imagn=imagn_default,ialflu,ianiso=ianiso_default,ipop3=ipop3_default,&
      ibasnet=ibasnet_default,phase,EOS=EOS_default
...
!-----------------------------------------------------------------------
  namelist /PhysicsParams/irot,isol,imagn,ialflu,ianiso,ipop3,ibasnet,phase,EOS,var_rates,bintide,binm2,periodini,const_per
!-----------------------------------------------------------------------
